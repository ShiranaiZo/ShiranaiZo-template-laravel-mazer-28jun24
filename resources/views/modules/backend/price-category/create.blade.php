    ...
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-content">
                <div class="card-body">
                    <form class="form form-vertical" action="{{ route('price.store') }}" method="POST">
                        @method('POST')
                        @csrf
                        <div class="form-body">
                            <div class="row">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="min" class="form-control" value="">
                                </div>
                                <div class="mb-3">
                                    <label for="" class="form-label">Max Value</label>
                                    <input type="number" name="max" class="form-control" value="">
                                </div>
